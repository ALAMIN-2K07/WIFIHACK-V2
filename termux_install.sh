...
echo ""
echo "╔════════════════════════════════════════════════════╗"
echo "║             ᯤ  WiFi Hacker Installer               ║"
echo "║           Advanced Auto System v2.0                ║"
echo "╠════════════════════════════════════════════════════╣"
echo "║  MODDER: MOHAMMAD ALAMIN                           ║"
echo "║  Telegram: ALAMIN2K07                              ║"
...
echo -e "${GREEN} ᯤ WiFi Hacker has been installed successfully! ✅${NC}"
echo ""
...
echo -e "${GREEN}ᯤ  Happy Ethical Hacking! ᯤ${NC}"
echo -e "${CYAN}Mod by MOHAMMAD ALAMIN${NC}"
echo ""
